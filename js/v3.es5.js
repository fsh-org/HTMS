...
function _SFile() {
  _SFile = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(url) {
          ...
          return _context5.abrupt("return", new Promise(function (resolve, reject) {
            if (!files[url]) {
              fetch(url).then(/*#__PURE__*/function () {
                var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(re) {
...
function SUpdate() {
  ...
  var SMainElem = Array.from(document.getElementsByTagName('htms'));
  ...
  var SFig = SMainElem.innerHTML.split('\n').filter(function (e) {
    return e.length > 0;
  });
  SFig = SFig.map(function (e) {
    return e.split(' ').filter(function (d) {
      return d.length > 0;
    }).join(' ');
  });
  SFig = SFig.filter(function (e) {
    return e.length > 0;
  });
  SFig = SFig.filter(function (e) {
    return !e.startsWith('//');
  ...
  var _loop = function _loop() {
      ...
      if (action == "import") {
        ...
        SFile(args[3]).then(function (dd) {
          args[1].split(',').map(function (ee) {
            return ee.slice(1, ee.length - 1);
          }).forEach(function (t) {
        ...
        Array.from(document.getElementsByTagName(args[1].slice(1, args[1].length - 1))).forEach(/*#__PURE__*/function () {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 8:
                  ...
                  ht = imports[args[3].slice(1, args[3].length - 1)];
                  if ((elm.attributes['var'] || '').value) {
                    elm.attributes['var'].value.split(';').filter(function (e) {
                      return e.length;
                    }).forEach(function (t) {
        ...
        Array.from(document.getElementsByTagName(args[1].slice(1, args[1].length - 1))).forEach(/*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(elm) {
            var i, ht;
        ...
        fetch('https://htms.fsh.plus/module/' + args[1].slice(1, args[1].length - 1) + '/module.js').then(/*#__PURE__*/function () {
          var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(h) {
