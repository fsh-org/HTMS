...
function SUpdate() {
  ...
  var config = document.getElementsByTagName("htms");
  if (config.length > 1) {
  ...
  config.forEach(function (e) {
    config[config.indexOf(e)] = e.split("").filter(function (o) {
      return !(o == " ");
    }).join("").replaceAll('\"', " ");
  });
  config = config.filter(function (o) {
    return !o == "";
  });
  var data = {};
  config.forEach(function (e) {
    ...
    switch (t[0]) {
      case 'import':
        ...
        ;
        var tg = t.slice(1, t.length - 2);
        for (var i = 0; i < tg.length; i = i + 2) {
      ...
      case 'inject':
        ...
        if (data[t[3]]) {
          Array.from(document.getElementsByTagName(t[1])).forEach(function (h) {
            fetch(data[t[3]]).then(/*#__PURE__*/function () {
              var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tr) {
                var tt, doc, coun;
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      tt = _context.sent;
                      doc = HtmsToElement(tt);
                      coun = 0;
                      Array.from(doc).forEach(function (s) {
                        if (s.attributes[0].nodeValue == t[3]) {
                          coun += 1;
                          var rh = s.innerHTML;
                          var vars = h.getAttribute("var");
                          if (String(vars) != 'null') {
                            vars.split(';').forEach(function (fr) {
                              var bal = fr.trim().split(':');
                              bal[0] = '${' + bal[0] + '}';
                              if (bal.length > 1) {
                      ...
                      throw new Error("".concat(t[3], " not defined in ").concat(data[t[3]]));
                    case 8:
                    case "end":
